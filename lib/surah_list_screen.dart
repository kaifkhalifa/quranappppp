...
import 'duas_screen.dart'; // Import the DuasScreen class
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: IconButton(
              icon: Icon(Icons.article), // Change the icon to whatever you prefer for Duas
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DuasScreen()), // Create DuasScreen
                );
              },
            ),
            label: 'Duas',
